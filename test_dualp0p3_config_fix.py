...
def test_dualp0p3_config_resolution():
    ...
    try:
        ...
        config_path = create_model_config_path(
            yolo_size="l", dinoversion="3", dino_variant="vitb16", integration="dualp0p3"
        )
...
if __name__ == "__main__":
    ...
    if test1_passed and test2_passed:
        ...
        print(
            "python train_yolov12_dino.py --data data.yaml --yolo-size l --dino-variant vitb16 --integration dualp0p3 --epochs 400"
        )
    else:
