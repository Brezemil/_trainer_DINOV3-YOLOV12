...
def main():
    ...
    # Input
    y = start_y
    create_rounded_rect(svg, center_x - box_w/2, y, box_w, box_h, 10, **style_input, stroke_width=2, label="Input Image")
    prev_y = y + box_h
    
    # P0 DINO
    y += gap_y
    create_rounded_rect(svg, center_x - box_w/2, y, box_w, box_h, 5, **style_dino, stroke_width=2, label="DINO3Preprocessor", sublabel="P0 Input")
    create_arrow(svg, center_x, prev_y, center_x, y)
    prev_y = y + box_h
    
    # P1 Conv
    y += gap_y
    create_rounded_rect(svg, center_x - box_w/2, y, box_w, box_h, 5, **style_conv, stroke_width=2, label="Conv", sublabel="P1/2")
    create_arrow(svg, center_x, prev_y, center_x, y)
    prev_y = y + box_h

    # P2 Conv
    y += gap_y
    create_rounded_rect(svg, center_x - box_w/2, y, box_w, box_h, 5, **style_conv, stroke_width=2, label="Conv", sublabel="P2/4")
    create_arrow(svg, center_x, prev_y, center_x, y)
    prev_y = y + box_h
    
    # P2 C3k2
    y += gap_y
    create_rounded_rect(svg, center_x - box_w/2, y, box_w, box_h, 5, **style_block, stroke_width=2, label="C3k2", sublabel="P2")
    create_arrow(svg, center_x, prev_y, center_x, y)
    prev_y = y + box_h

    # P3 Conv
    y += gap_y
    create_rounded_rect(svg, center_x - box_w/2, y, box_w, box_h, 5, **style_conv, stroke_width=2, label="Conv", sublabel="P3/8")
    create_arrow(svg, center_x, prev_y, center_x, y)
    prev_y = y + box_h

    # P3 C3k2
    y += gap_y
    create_rounded_rect(svg, center_x - box_w/2, y, box_w, box_h, 5, **style_block, stroke_width=2, label="C3k2", sublabel="Standard P3")
    create_arrow(svg, center_x, prev_y, center_x, y)
    prev_y = y + box_h
    p3_y = y + box_h/2 # Save P3 center Y

    # P3 DINO
    y += gap_y
    create_rounded_rect(svg, center_x - box_w/2, y, box_w, box_h, 5, **style_dino, stroke_width=2, label="DINO3Backbone", sublabel="Enhanced P3")
    create_arrow(svg, center_x, prev_y, center_x, y)
    prev_y = y + box_h
    ...
    # P4 Conv
    y += gap_y
    create_rounded_rect(svg, center_x - box_w/2, y, box_w, box_h, 5, **style_conv, stroke_width=2, label="Conv", sublabel="P4/16")
    create_arrow(svg, center_x, prev_y, center_x, y)
    prev_y = y + box_h

    # P4 A2C2f
    y += gap_y
    create_rounded_rect(svg, center_x - box_w/2, y, box_w, box_h, 5, **style_block, stroke_width=2, label="A2C2f", sublabel="Standard P4")
    create_arrow(svg, center_x, prev_y, center_x, y)
    prev_y = y + box_h
    ...
    # P5 Conv
    y += gap_y
    create_rounded_rect(svg, center_x - box_w/2, y, box_w, box_h, 5, **style_conv, stroke_width=2, label="Conv", sublabel="P5/32")
    create_arrow(svg, center_x, prev_y, center_x, y)
    prev_y = y + box_h

    # P5 A2C2f
    y += gap_y
    create_rounded_rect(svg, center_x - box_w/2, y, box_w, box_h, 5, **style_block, stroke_width=2, label="A2C2f", sublabel="Standard P5")
    create_arrow(svg, center_x, prev_y, center_x, y)
    prev_y = y + box_h
    ...
    # Concat with P4
    h_y = p4_y
    create_rounded_rect(svg, head_x - box_w/2, h_y, box_w, box_h, 5, **style_head, stroke_width=2, label="A2C2f", sublabel="Head P4")
    ...
    create_rounded_rect(svg, head_x - box_w/2, h_y, box_w, box_h, 5, **style_head, stroke_width=2, label="A2C2f", sublabel="Head P3 (Small)")
    ...
    create_rounded_rect(svg, head_x + 200, h_y, box_w, box_h, 5, **style_head, stroke_width=2, label="A2C2f", sublabel="Head P4 (Medium)")
    # Arrow from Head P3
    ...
    create_rounded_rect(svg, head_x + 200, h_y, box_w, box_h, 5, **style_head, stroke_width=2, label="C3k2", sublabel="Head P5 (Large)")
    ...
    create_rounded_rect(svg, detect_x - (box_w * 2.5) / 2, detect_y, box_w * 2.5, box_h, 5, **style_detect, stroke_width=2, label="Detect", sublabel="P3, P4, P5")
    ...
    # From P3 (Head P3)
    create_elbow_arrow(svg, head_x - box_w/2, head_p3_y + box_h/2, detect_target_x - 100, detect_target_y, head_x - box_w/2) 
    # From P4 (Head P4 Out)
    create_elbow_arrow(svg, head_p4_out_x + box_w/2, head_p4_out_y + box_h, detect_target_x, detect_target_y, head_p4_out_x + box_w/2)
    # From P5 (Head P5 Out)
    create_elbow_arrow(svg, head_p5_out_x + box_w/2, head_p5_out_y + box_h, detect_target_x + 100, detect_target_y, head_p5_out_x + box_w/2)
