---
source_url: https://docs.voxel51.com/dataset_zoo/datasets/kinetics_400.html
---
...
**Details**
  ...
  * ZooDataset class: [`Kinetics400Dataset`](api__fiftyone.zoo.datasets.base.md#fiftyone.zoo.datasets.base.Kinetics400Dataset "fiftyone.zoo.datasets.base.Kinetics400Dataset")
...
Unlike other versions, Kinetics 400 does not have zips available by class so whenever either `classes` or `max_samples` is provided, videos will be downloaded from YouTube.
