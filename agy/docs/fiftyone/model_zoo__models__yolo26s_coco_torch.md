---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26s_coco_torch.html
---

# yolo26s-coco-torch#

Fast NMS-free detector balancing speed and accuracy.

**Details**

  * Model name: `yolo26s-coco-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("yolo26s-coco-torch")
    13
