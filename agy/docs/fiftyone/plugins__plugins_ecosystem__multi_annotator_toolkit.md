---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/multi_annotator_toolkit.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/Madave94/multi-annotator-toolkit)

# Multi Annotator Toolkit#

This is a plugin for the [FiftyOne framework](https://github.com/voxel51/fiftyone) that allows analysis of multi-annotated data. It is associated with our WACV publication 1 looking into Label Convergence in Object Recognition as well as analysis of annotation errors/variations.

![Noisy Labels](https://raw.githubusercontent.com/Madave94/multi-annotator-toolkit/master/assets/teaser_noise.png)

_Example of noisy annotation on a concrete structure, annotated by multiple civil engineers. Different colors indicate different annotators._
...
![](https://raw.githubusercontent.com/Madave94/multi-annotator-toolkit/master/assets/plugin-overview.png)
...
## Multi-Annotator-Toolkit Hello World using LVIS#
  ...
  1. Download the consistency annotations here: [Madave94/LVIS-Double-Annotations](https://github.com/Madave94/LVIS-Double-Annotations/tree/master/processed_double_annos_v1.0)  
...
`wget http://images.cocodataset.org/zips/val2017.zip`
  ...
  5. In case you are running an object detection dataset (only bounding boxes) change label_types to [âdetectionsâ].
...
Coming soon.. for now please request the description from [David Tschirschwitz via e-mail](mailto:david.tschirschwitz%40uni-weimar.de).

You can already add your own dataset with some technical knowledge and formatting your data correctly. Please follow the docstring description in `__init__.py` for the function `LoadMultiAnnotatedData`.

## Reference#

[1] Tschirschwitz David and Rodehorst Volker . âLabel Convergence: Defining an Upper Performance Bound in Object Recognition through Contradictory Annotationsâ _Proceedings of the IEEE/CVF Winter Conference on Applications of Computer Vision (WACV)_. 2025. [Link](https://arxiv.org/abs/2409.09412)
