---
source_url: https://docs.voxel51.com/model_zoo/overview.html
---
...
The basic recipe for working with zoo models is to load one via [`load_zoo_model()`](api__fiftyone.zoo.models.md#fiftyone.zoo.models.load_zoo_model "fiftyone.zoo.models.load_zoo_model") and then apply it to a dataset or view using methods like [`apply_model()`](api__fiftyone.core.collections.md#fiftyone.core.collections.SampleCollection.apply_model "fiftyone.core.collections.SampleCollection.apply_model") and [`compute_embeddings()`](api__fiftyone.core.collections.md#fiftyone.core.collections.SampleCollection.compute_embeddings "fiftyone.core.collections.SampleCollection.compute_embeddings").

You can generate model predictions by passing any zoo model to the [`apply_model()`](api__fiftyone.core.collections.md#fiftyone.core.collections.SampleCollection.apply_model "fiftyone.core.collections.SampleCollection.apply_model") method of a dataset or view.

For example, the code sample below shows a self-contained example of loading a Faster R-CNN model from the model zoo and adding its predictions to the [COCO-2017 dataset](dataset_zoo__datasets__coco_2017.md#dataset-zoo-coco-2017):
...
For models that expose embeddings, you can generate embeddings for all samples in a dataset or view by calling [`compute_embeddings()`](api__fiftyone.core.collections.md#fiftyone.core.collections.SampleCollection.compute_embeddings "fiftyone.core.collections.SampleCollection.compute_embeddings"):
...
Storing logits for predictions enables you to run Brain methods such as [label mistakes](brain.md#brain-label-mistakes) and [sample hardness](brain.md#brain-sample-hardness) on your datasets!

You can check if a model exposes logits via [`has_logits()`](api__fiftyone.core.models.md#fiftyone.core.models.Model.has_logits "fiftyone.core.models.Model.has_logits"):
...
For models that expose logits, you can store logits for all predictions generated by [`apply_model()`](api__fiftyone.core.collections.md#fiftyone.core.collections.SampleCollection.apply_model "fiftyone.core.collections.SampleCollection.apply_model") by passing the optional `store_logits=True` argument:
...
Zoo models may require additional packages such as PyTorch or TensorFlow (or specific versions of them) in order to be used. See [this section](model_zoo__api.md#model-zoo-requirements) for more information on viewing/installing package requirements for models.
...
Depending on your compute environment, some package requirement failures may be erroneous. In such cases, you can [suppress error messages](model_zoo__api.md#model-zoo-load).
...
[ Explore the models in the zoo ](https://docs.voxel51.com/model_zoo/index.html)
...
[ Learn how to download remote models ](model_zoo__remote.md)
...
[ Grok the Model interface ](model_zoo__design.md)

Note

Did you know? You can also pass [custom models](model_zoo__design.md#model-zoo-custom-models) to methods like [`apply_model()`](api__fiftyone.core.collections.md#fiftyone.core.collections.SampleCollection.apply_model "fiftyone.core.collections.SampleCollection.apply_model") and [`compute_embeddings()`](api__fiftyone.core.collections.md#fiftyone.core.collections.SampleCollection.compute_embeddings "fiftyone.core.collections.SampleCollection.compute_embeddings")!
...
[ Check out the API reference ](model_zoo__api.md)
