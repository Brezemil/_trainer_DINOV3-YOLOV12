---
source_url: https://docs.voxel51.com/getting_started/auto_labeling/01_preparation.html
---
...
To create a dataset in FiftyOne Enterprise and load in samples, see [creating datasets](enterprise__app.md#enterprise-creating-datasets). In order to include specific examples in this guide we will be using an unlabeled version of the [BDD100K image dataset](dataset_zoo__datasets__bdd100k.md#dataset-zoo-bdd100k) available in the [FiftyOne dataset zoo](https://docs.voxel51.com/dataset_zoo/index.html).
...
With your infrastructure prepared and dataset ready, youâre now set to configure your first auto labeling run.

In the next section, youâll learn how to:
...
Click **Next** to continue to [Step 2: Configure Auto Label Run](getting_started__auto_labeling__02_configure_run.md#val-configure-run).
