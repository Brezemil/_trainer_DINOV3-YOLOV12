---
source_url: https://docs.voxel51.com/model_zoo/models/Qwen_Qwen2_5_VL_32B_Instruct_AWQ.html
---
...
**Details**
  ...
  * Model name: `Qwen/Qwen2.5-VL-32B-Instruct-AWQ`

  * Model source: <https://huggingface.co/Qwen/Qwen2.5-VL-32B-Instruct-AWQ>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("Qwen/Qwen2.5-VL-32B-Instruct-AWQ")
    15
