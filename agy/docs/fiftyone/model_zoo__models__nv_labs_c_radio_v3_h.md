---
source_url: https://docs.voxel51.com/model_zoo/models/nv_labs_c_radio_v3_h.html
---
...
**Details**
  ...
  * Model name: `nv_labs/c-radio_v3-h`
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("nv_labs/c-radio_v3-h")
    15
