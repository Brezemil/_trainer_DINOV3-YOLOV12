---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/gui_actor.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/gui_actor)

# GUI-Actor FiftyOne Integration#

A FiftyOne integration for Microsoftâs GUI-Actor vision-language models, enabling GUI automation and visual interface analysis with rich attention visualization.

![](gui-actor-hq.gif)

## Overview#

GUI-Actor is a multimodal foundation model designed for GUI automation tasks. This integration brings GUI-Actorâs capabilities to FiftyOne, allowing you to:
...
## Features#
  ...
  * **Seamless Integration** : Works with FiftyOneâs dataset management and visualization
