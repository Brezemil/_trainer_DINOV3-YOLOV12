---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26m_pose_coco_torch.html
---

# yolo26m-pose-coco-torch#

NMS-free pose estimation with improved keypoint accuracy.

**Details**

  * Model name: `yolo26m-pose-coco-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("yolo26m-pose-coco-torch")
    13
