---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26l_cls_imagenet_torch.html
---

# yolo26l-cls-imagenet-torch#

High-accuracy image classifier.

**Details**

  * Model name: `yolo26l-cls-imagenet-torch`
...
**Example usage**
     ...
     9)
    10
    11model = foz.load_zoo_model("yolo26l-cls-imagenet-torch")
    12
