---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/clustering.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/jacobmarks/clustering-plugin)
...
It also serves as a proof of concept for adding new âtypesâ of runs to FiftyOne!!!
...
To use this functionality, you must have an API key for OpenAIâs GPT-4V API, and you must set it in your environment as `OPENAI_API_KEY`.
