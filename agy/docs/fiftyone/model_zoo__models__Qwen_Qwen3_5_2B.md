---
source_url: https://docs.voxel51.com/model_zoo/models/Qwen_Qwen3_5_2B.html
---
...
**Details**
  ...
  * Model source: <https://huggingface.co/Qwen/Qwen3.5-2B>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("Qwen/Qwen3.5-2B")
    15
