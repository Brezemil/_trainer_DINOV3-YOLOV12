...
![3bed727aeef14d289fa4a3d98aeb3648](../_images/augmentations_initial_dataset.png) Subset of 10 images from the train split of the KITTI dataset, visualized in the FiftyOne App To make things more fun â and to show that this plugin allows you to experiment with all different types of labels â letâs add some pose estimation keypoints with [Ultralytics](https://docs.ultralytics.com/), and some relative depth maps with Hugging Faceâs [Transformers](https://huggingface.co/docs/transformers/index) library:
