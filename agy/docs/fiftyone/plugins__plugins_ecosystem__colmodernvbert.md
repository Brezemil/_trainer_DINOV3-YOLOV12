---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/colmodernvbert.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/colmodernvbert)
...
![image](https://raw.githubusercontent.com/harpreetsahota204/colmodernvbert/main/colmodernvbert_fo.gif)
...
ColModernVBert uses a **multi-vector architecture** inspired by ColBERT, where each input (image or text) is represented by multiple vectors rather than a single embedding:
    ...
    # Image or Text â Processor â Model â (batch, num_vectors, 128)
...
For efficient large-scale search, multi-vectors are pooled to fixed 128-dim embeddings:
    ...
    Multi-vectors (N, 128) â Final Pooling (mean/max) â 128-dim vector
...
For accurate classification, full multi-vectors are used with MaxSim scoring:
    ...
    Image multi-vectors Ã Text multi-vectors â MaxSim â Classification scores
    ...
    > _predict_all()
        ...
        > processor.score() with MaxSim
            > Returns (batch, num_classes) logits
                > Output processor â Classification labels
...
If you use ColModernVBert in your research, please cite:
    ...
    @misc{teiletche2025modernvbertsmallervisualdocument,
          ...
          author={Paul Teiletche and Quentin MacÃ© and Max Conti and Antonio Loison and Gautier Viaud and Pierre Colombo and Manuel Faysse},
          year={2025},
          eprint={2510.01149},
          archivePrefix={arXiv},
          primaryClass={cs.IR},
