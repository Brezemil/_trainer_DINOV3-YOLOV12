---
source_url: https://docs.voxel51.com/api/fiftyone.utils.rfdetr.html
---

# fiftyone.utils.rfdetr#

[RF-DETR](https://github.com/roboflow/rf-detr) wrapper for the FiftyOne Model Zoo.
...
`RFDETRDetectionModelConfig`(d) | Configuration for running a `RFDETRDetectionModel`.  
---|---  
`RFDETRSegmentationModelConfig`(d) | Configuration for running a `RFDETRSegmentationModel`.  
`RFDETRDetectionModel`(config) | FiftyOne wrapper around an RF-DETR object detection model.  
`RFDETRSegmentationModel`(config) | FiftyOne wrapper around an RF-DETR instance segmentation model.  
  
class fiftyone.utils.rfdetr.RFDETRDetectionModelConfig(_d_)#
...
Configuration for running a `RFDETRDetectionModel`.
...
**model_type** (_None_) â the RF-DETR model class name to load, e.g. `"RFDETRMedium"`
...
class fiftyone.utils.rfdetr.RFDETRSegmentationModelConfig(_d_)#
    

Bases: [`TorchImageModelConfig`](api__fiftyone.utils.torch.md#fiftyone.utils.torch.TorchImageModelConfig "fiftyone.utils.torch.TorchImageModelConfig"), [`HasZooModel`](api__fiftyone.zoo.models.md#fiftyone.zoo.models.HasZooModel "fiftyone.zoo.models.HasZooModel")

Configuration for running a `RFDETRSegmentationModel`.
...
**model_type** (_None_) â the RF-DETR segmentation model class name to load, e.g. `"RFDETRSegMedium"`
...
class fiftyone.utils.rfdetr.RFDETRDetectionModel(_config_)#
    

Bases: `_RFDETRBaseModel`
...
**config** â a `RFDETRDetectionModelConfig`
...
`predict_all`(imgs[,Â samples]) | Performs prediction on the given batch of images.  
...
static collate_fn(_batch : [list](api__fiftyone.core.session.events.md#fiftyone.core.session.events.Colorscale.list "fiftyone.core.session.events.Colorscale.list")[Any]_) → [list](api__fiftyone.core.session.events.md#fiftyone.core.session.events.Colorscale.list "fiftyone.core.session.events.Colorscale.list")[Any]#
...
property has_collate_fn: [bool](api__fiftyone.core.stages.md#fiftyone.core.stages.Exists.bool "fiftyone.core.stages.Exists.bool")#
...
predict_all(_imgs : [list](api__fiftyone.core.session.events.md#fiftyone.core.session.events.Colorscale.list "fiftyone.core.session.events.Colorscale.list")[Any]_, _samples : [list](api__fiftyone.core.session.events.md#fiftyone.core.session.events.Colorscale.list "fiftyone.core.session.events.Colorscale.list")[Any] | None = None_) → [list](api__fiftyone.core.session.events.md#fiftyone.core.session.events.Colorscale.list "fiftyone.core.session.events.Colorscale.list")[[Detections](https://docs.voxel51.com/api/fiftyone.core.labels.html#fiftyone.core.labels.Detections "fiftyone.core.labels.Detections")]#
...
class fiftyone.utils.rfdetr.RFDETRSegmentationModel(_config_)#
...
**config** â a `RFDETRSegmentationModelConfig`
