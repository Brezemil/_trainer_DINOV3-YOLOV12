---
source_url: https://docs.voxel51.com/dataset_zoo/datasets_hf/synthhuman.html
---
...
[![Hugging Face](https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Dataset-yellow)](https://huggingface.co/datasets/Voxel51/SynthHuman)

# Dataset Card for SynthHuman#

![image/png](https://huggingface.co/datasets/Voxel51/SynthHuman/resolve/main/synthhuman-mq.gif)
...
#### Additional resources#
  ...
  * **Checkout this notebook to learn how to do some cool analysis with this dataset** : https://github.com/harpreetsahota204/synthhuman_to_fiftyone/blob/main/SynthHuman_in_FiftyOne.ipynb
...
The SynthHuman dataset contains 300,000 synthetic images of resolution 384Ã512, with equal distribution (100,000 each) across three categories:
...
While the paper doesnât explicitly discuss biases in the dataset, there are potential limitations:
  ...
  * Failure cases noted in the paper include extreme lighting conditions, printed patterns on clothing, tattoos, and rare scale variations (e.g., a baby held in an adultâs hand)
