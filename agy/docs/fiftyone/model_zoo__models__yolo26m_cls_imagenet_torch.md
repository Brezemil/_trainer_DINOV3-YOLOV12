---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26m_cls_imagenet_torch.html
---

# yolo26m-cls-imagenet-torch#

Medium image classifier for general use.

**Details**

  * Model name: `yolo26m-cls-imagenet-torch`
...
**Example usage**
     ...
     9)
    10
    11model = foz.load_zoo_model("yolo26m-cls-imagenet-torch")
    12
