---
source_url: https://docs.voxel51.com/labs/labs_ecosystem/label_propagation.html
---

[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/voxel51/fiftyone-labs/tree/main/plugins/label_propagation)

# Label Propagation Plugin#

Propagate annotations from sparsely labeled âexemplar framesâ to all frames in a sequence using SAM-2.
...
![Label Propagation](https://raw.githubusercontent.com/voxel51/fiftyone-labs/main/plugins/label_propagation/assets/propagation.png)
...
### Parameters#
  ...
  * **`temporal_segments_field`** â Field in which to store classifications
...
The **Label Propagation** panel provides an interactive UI for the complete workflow:
  ...
  3. Configure the temporal segments field â this may already exist, or will be where temporal detections are stored.
...
![Panel View](https://raw.githubusercontent.com/voxel51/fiftyone-labs/main/plugins/label_propagation/assets/panel.png)
...
The annotations in `labels_test` exist only for the first frame within each temporal segment â you can play around with the panel and operators to propagate them to all.
...
Other features on the roadmap
  ...
  * [ ] UX features that support HA (e.g. edit label field, âselectâ instances)
