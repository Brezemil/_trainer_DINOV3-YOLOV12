---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26m_coco_torch.html
---

# yolo26m-coco-torch#

NMS-free detector with improved small object detection.

**Details**

  * Model name: `yolo26m-coco-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("yolo26m-coco-torch")
    13
