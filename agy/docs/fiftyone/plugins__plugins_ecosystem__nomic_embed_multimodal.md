---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/nomic_embed_multimodal.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/nomic-embed-multimodal)
...
![image](https://raw.githubusercontent.com/harpreetsahota204/nomic-embed-multimodal/main/nomicemb_fo.gif)
...
Nomic Embed Multimodal uses a **single-vector architecture** where each input (image or text) is compressed into a single high-dimensional embedding:
    ...
    # Image or Text â Processor â Model â (3584,) embedding
...
**Classification Pipeline:**
    ...
    > _predict_all()
        ...
        > processor.score() â Cosine similarity
