---
source_url: https://docs.voxel51.com/model_zoo/models/google_siglip2_base_patch16_naflex.html
---
...
**Details**
  ...
  * Model name: `google/siglip2-base-patch16-naflex`

  * Model source: <https://huggingface.co/google/siglip2-base-patch16-naflex>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("google/siglip2-base-patch16-naflex")
    15
