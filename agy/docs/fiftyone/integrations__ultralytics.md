---
source_url: https://docs.voxel51.com/integrations/ultralytics.html
---
...
You can directly pass Ultralytics `YOLO` classification models to [`apply_model()`](api__fiftyone.core.collections.md#fiftyone.core.collections.SampleCollection.apply_model "fiftyone.core.collections.SampleCollection.apply_model"):
...
You can directly pass Ultralytics `YOLO` or `RTDETR` detection models to [`apply_model()`](api__fiftyone.core.collections.md#fiftyone.core.collections.SampleCollection.apply_model "fiftyone.core.collections.SampleCollection.apply_model"):
...
Alternatively, you can use the [`to_detections()`](api__fiftyone.utils.ultralytics.md#fiftyone.utils.ultralytics.to_detections "fiftyone.utils.ultralytics.to_detections") utility to manually convert Ultralytics predictions to [FiftyOne format](https://docs.voxel51.com/user_guide/using_datasets.html#object-detection):
...
You can also load any of these models directly from the [FiftyOne Model Zoo](https://docs.voxel51.com/model_zoo/index.html#model-zoo):
...
You can use [`list_zoo_models()`](api__fiftyone.zoo.md#fiftyone.zoo.list_zoo_models "fiftyone.zoo.list_zoo_models") to see all available YOLO models that are compatible with Ultralytics or SuperGradients:
...
You can directly pass Ultralytics YOLO segmentation models to [`apply_model()`](api__fiftyone.core.collections.md#fiftyone.core.collections.SampleCollection.apply_model "fiftyone.core.collections.SampleCollection.apply_model"):
...
Alternatively, you can use the [`to_instances()`](api__fiftyone.utils.ultralytics.md#fiftyone.utils.ultralytics.to_instances "fiftyone.utils.ultralytics.to_instances") and [`to_polylines()`](api__fiftyone.utils.ultralytics.md#fiftyone.utils.ultralytics.to_polylines "fiftyone.utils.ultralytics.to_polylines") utilities to manually convert Ultralytics predictions into the desired [FiftyOne format](https://docs.voxel51.com/user_guide/using_datasets.html#instance-segmentation):
...
You can also load YOLOv8, YOLOv9, and YOLO11 segmentation models from the [FiftyOne Model Zoo](https://docs.voxel51.com/model_zoo/index.html#model-zoo):
...
You can directly pass Ultralytics YOLO pose models to [`apply_model()`](api__fiftyone.core.collections.md#fiftyone.core.collections.SampleCollection.apply_model "fiftyone.core.collections.SampleCollection.apply_model"):
...
Alternatively, you can use the [`to_keypoints()`](api__fiftyone.utils.ultralytics.md#fiftyone.utils.ultralytics.to_keypoints "fiftyone.utils.ultralytics.to_keypoints") utility to manually convert Ultralytics predictions to [FiftyOne format](https://docs.voxel51.com/user_guide/using_datasets.html#keypoints):
...
You can directly pass Ultralytics YOLO oriented bounding box models to [`apply_model()`](api__fiftyone.core.collections.md#fiftyone.core.collections.SampleCollection.apply_model "fiftyone.core.collections.SampleCollection.apply_model"):
...
You can also load YOLOv8 oriented bounding box models from the [FiftyOne Model Zoo](https://docs.voxel51.com/model_zoo/index.html#model-zoo):
...
You can also load these open-vocabulary models from the [FiftyOne Model Zoo](https://docs.voxel51.com/model_zoo/index.html#model-zoo), optionally specifying the classes that the model should detect:
...
You can also provide overrides to the underlying Ultralytics model by passing them as kwargs to [`load_zoo_model()`](api__fiftyone.zoo.models.md#fiftyone.zoo.models.load_zoo_model "fiftyone.zoo.models.load_zoo_model"):
...
You can use FiftyOneâs builtin [YOLOv5 exporter](user_guide__export_datasets.md#yolov5dataset-export) to export your FiftyOne datasets for use with Ultralytics models.

For example, the code below prepares a random subset of the [Open Images v7 dataset](dataset_zoo__datasets__open_images_v7.md#dataset-zoo-open-images-v7) for fine-tuning:
