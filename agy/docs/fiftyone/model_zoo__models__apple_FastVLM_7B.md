---
source_url: https://docs.voxel51.com/model_zoo/models/apple_FastVLM_7B.html
---
...
**Details**
  ...
  * Model name: `apple/FastVLM-7B`

  * Model source: <https://huggingface.co/apple/FastVLM-7B>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("apple/FastVLM-7B")
    15
