---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26s_seg_coco_torch.html
---

# yolo26s-seg-coco-torch#

Fast NMS-free instance segmentation.

**Details**

  * Model name: `yolo26s-seg-coco-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("yolo26s-seg-coco-torch")
    13
