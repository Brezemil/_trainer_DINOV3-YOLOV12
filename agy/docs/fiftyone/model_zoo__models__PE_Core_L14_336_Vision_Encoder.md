---
source_url: https://docs.voxel51.com/model_zoo/models/PE_Core_L14_336_Vision_Encoder.html
---

# PE-Core-L14-336-Vision-Encoder#

The ViT from the large variant of the PE Core line of models..

**Details**

  * Model name: `PE-Core-L14-336-Vision-Encoder`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("PE-Core-L14-336-Vision-Encoder")
    13
