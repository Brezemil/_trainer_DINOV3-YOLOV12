---
source_url: https://docs.voxel51.com/model_zoo/models/google_siglip2_giant_opt_patch16_384.html
---
...
**Details**
  ...
  * Model source: <https://huggingface.co/google/siglip2-giant-opt-patch16-384>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("google/siglip2-giant-opt-patch16-384")
    15
