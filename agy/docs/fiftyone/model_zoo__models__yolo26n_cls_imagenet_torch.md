---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26n_cls_imagenet_torch.html
---

# yolo26n-cls-imagenet-torch#

Ultra-fast image classifier for edge devices.

**Details**

  * Model name: `yolo26n-cls-imagenet-torch`
...
**Example usage**
     ...
     9)
    10
    11model = foz.load_zoo_model("yolo26n-cls-imagenet-torch")
    12
