---
source_url: https://docs.voxel51.com/api/fiftyone.brain.internal.core.representativeness.html
---
...
`compute_representativeness`(samples,Â ...) | See `fiftyone/brain/__init__.py`.  
---|---  
  
**Classes:**

`RepresentativenessConfig`(...[,Â method,Â ...]) |   
---|---  
`Representativeness`(config) |   
  
fiftyone.brain.internal.core.representativeness.compute_representativeness(_samples_ , _representativeness_field_ , _method_ , _roi_field_ , _embeddings_ , _similarity_index_ , _model_ , _model_kwargs_ , _force_square_ , _alpha_ , _batch_size_ , _num_workers_ , _skip_failures_ , _progress_)#
    

See `fiftyone/brain/__init__.py`.

class fiftyone.brain.internal.core.representativeness.RepresentativenessConfig(_representativeness_field_ , _method =None_, _roi_field =None_, _embeddings_field =None_, _similarity_index =None_, _model =None_, _model_kwargs =None_, _** kwargs_)#
...
class fiftyone.brain.internal.core.representativeness.Representativeness(_config_)#
