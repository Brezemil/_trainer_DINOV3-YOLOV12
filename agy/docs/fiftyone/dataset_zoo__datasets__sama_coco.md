---
source_url: https://docs.voxel51.com/dataset_zoo/datasets/sama_coco.html
---
...
**Details**
  ...
  * ZooDataset class: [`SamaCOCODataset`](api__fiftyone.zoo.datasets.base.md#fiftyone.zoo.datasets.base.SamaCOCODataset "fiftyone.zoo.datasets.base.SamaCOCODataset")
...
The following parameters are available to configure a partial download of Sama-COCO by passing them to [`load_zoo_dataset()`](api__fiftyone.zoo.datasets.md#fiftyone.zoo.datasets.load_zoo_dataset "fiftyone.zoo.datasets.load_zoo_dataset"):
