---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26n_pose_coco_torch.html
---

# yolo26n-pose-coco-torch#

Ultra-fast NMS-free pose estimation for edge devices.

**Details**

  * Model name: `yolo26n-pose-coco-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("yolo26n-pose-coco-torch")
    13
