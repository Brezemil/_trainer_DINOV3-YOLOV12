---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/deepseek_ocr.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/deepseek_ocr)

# DeepSeek-OCR FiftyOne Zoo Model#

DeepSeek-OCR is a vision-language model designed for optical character recognition with a focus on âcontextual optical compression.â Unlike traditional OCR engines, it uses a dual-encoder architecture (SAM + CLIP) to process documents and convert them to structured text formats like Markdown.

![image](https://raw.githubusercontent.com/harpreetsahota204/deepseek_ocr/main/deepseekocr_fo.gif)
...
**How it works:**
    ...
    Your image (any size) â Resized/padded to [NÃN] â Single view â Fixed token count
...
**How it works:**
    ...
    Your image (any size) â [1024Ã1024 global view]  (overall structure)
                          + [640Ã640 patches Ã N]     (fine details)
                          â 256 + (N Ã 100) tokens
    

The model automatically determines how many 640Ã640 patches are needed based on your image dimensions.

**Visual Example:**

For a 2400Ã3200 pixel image with Gundam mode:
