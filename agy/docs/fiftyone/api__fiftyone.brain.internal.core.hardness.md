---
source_url: https://docs.voxel51.com/api/fiftyone.brain.internal.core.hardness.html
---
...
`compute_hardness`(samples,Â label_field,Â ...) | See `fiftyone/brain/__init__.py`.  
---|---  
  
**Classes:**

`HardnessConfig`(label_field,Â hardness_field,Â ...) |   
---|---  
`Hardness`(config) |   
  
fiftyone.brain.internal.core.hardness.compute_hardness(_samples_ , _label_field_ , _hardness_field_ , _progress_)#
    

See `fiftyone/brain/__init__.py`.

class fiftyone.brain.internal.core.hardness.HardnessConfig(_label_field_ , _hardness_field_ , _** kwargs_)#
...
class fiftyone.brain.internal.core.hardness.Hardness(_config_)#
