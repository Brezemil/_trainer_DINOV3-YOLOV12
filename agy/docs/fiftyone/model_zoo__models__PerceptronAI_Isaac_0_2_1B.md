---
source_url: https://docs.voxel51.com/model_zoo/models/PerceptronAI_Isaac_0_2_1B.html
---
...
Isaac 0.2 1B is an open-source, 1B-parameter model built for real-world applications. Isaac 0.2 is part of Perceptron AIâs family of models built to be the intelligence layer for the physical world..

**Details**

  * Model name: `PerceptronAI/Isaac-0.2-1B`

  * Model source: <https://huggingface.co/PerceptronAI/Isaac-0.2-1B>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("PerceptronAI/Isaac-0.2-1B")
    15
