---
source_url: https://docs.voxel51.com/plugins/api/plugins.operators.dataset.html
---

# plugins.operators.dataset#
...
`GetFieldSchema`([_builtin]) |   
---|---  
  
class plugins.operators.dataset.GetFieldSchema(__builtin =False_)#
