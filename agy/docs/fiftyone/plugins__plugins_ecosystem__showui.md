---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/showui.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/ShowUI)
...
![](https://raw.githubusercontent.com/harpreetsahota204/ShowUI/main/showui-hd.gif)
...
### Simple Grounding#
  ...
  * **System Prompt** : âBased on the screenshot of the page, I give a text description and you give its corresponding location. The coordinate represents a clickable location [x, y] for an element, which is a relative coordinate on the screenshot, scaled from 0 to 1.â
...
### Standard Actions#
  ...
  * **Simple Grounding** : Creates keypoints with label âgrounding_pointâ

  * **Actions with positions** : Creates keypoints with action-specific labels (e.g., âclickâ, âinputâ) and includes the action value
...
## Configuration Options#
  ...
  * **operation** : Set to âsimple_groundingâ or âaction_groundingâ
