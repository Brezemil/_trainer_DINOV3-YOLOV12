---
source_url: https://docs.voxel51.com/model_zoo/models/nv_labs_c_radio_v4_so400m.html
---
...
**Details**
  ...
  * Model name: `nv_labs/c-radio_v4-so400m`

  * Model source: <https://huggingface.co/nvidia/C-RADIOv4-SO400M>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("nv_labs/c-radio_v4-so400m")
    15
