---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/nemo_retriever_parse_plugin.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/nemo_retriever_parse_plugin)

# FiftyOne NeMo Retriever Parse Plugin#

![](https://raw.githubusercontent.com/harpreetsahota204/nemo_retriever_parse_plugin/main/assets/nemo_app.gif)

A FiftyOne plugin that integrates NVIDIAâs NeMo Retriever Parse model to detect and extract text regions from documents with their spatial locations.

This plugin enables you to process documents in your FiftyOne dataset through NVIDIAâs NeMo Retriever Parse model. It detects various types of text elements (titles, paragraphs, tables, etc.) and their locations in the document, returning both the text content and bounding box coordinates.
...
The model is currently in beta (v0.2) and is intended for demonstration purposes rather than production use. It operates under NVIDIAâs Software License Agreement.
...
## Error Handling#
  ...
  * Errors are logged but donât halt dataset processing
...
## Notes#
  ...
  * The plugin uses NVIDIAâs API which may have rate limits or usage costs
