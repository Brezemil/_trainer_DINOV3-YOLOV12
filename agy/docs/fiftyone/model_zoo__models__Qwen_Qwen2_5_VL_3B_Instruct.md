---
source_url: https://docs.voxel51.com/model_zoo/models/Qwen_Qwen2_5_VL_3B_Instruct.html
---
...
**Details**
  ...
  * Model source: <https://huggingface.co/Qwen/Qwen2.5-VL-3B-Instruct>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("Qwen/Qwen2.5-VL-3B-Instruct")
    15
