---
source_url: https://docs.voxel51.com/model_zoo/models/Qwen_Qwen3_5_27B_FP8.html
---
...
**Details**
  ...
  * Model source: <https://huggingface.co/Qwen/Qwen3.5-27B-FP8>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("Qwen/Qwen3.5-27B-FP8")
    15
