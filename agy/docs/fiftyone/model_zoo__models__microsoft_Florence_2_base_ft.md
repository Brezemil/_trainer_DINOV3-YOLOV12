---
source_url: https://docs.voxel51.com/model_zoo/models/microsoft_Florence_2_base_ft.html
---
...
**Details**
  ...
  * Model source: <https://huggingface.co/microsoft/Florence-2-base-ft>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("microsoft/Florence-2-base-ft")
    15
