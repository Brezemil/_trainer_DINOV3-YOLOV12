---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/fiftyone_tile.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/mmoollllee/fiftyone-tile)
...
Tiles will be saved to `destination`-dataset. As detections might be split over tiles boundaries, they might need refinement.
...
## Walkthrough#
  ...
  3. Make tiles with the given `tile_size` and transfer available detections to the tiles.
     ...
     * Omit labels at imageâs borders if the donât reach in the image by `threshold` value (in pixels)
...
![](https://raw.githubusercontent.com/mmoollllee/fiftyone-tile/main/screenshot.png)
