---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/kosmos2_5.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/kosmos2_5)

# Kosmos-2.5 for FiftyOne#

![Kosmos-2.5 Demo](https://raw.githubusercontent.com/harpreetsahota204/kosmos2_5/main/kosmos2_5-hq.gif)

A FiftyOne model plugin for [Microsoftâs Kosmos-2.5](https://huggingface.co/microsoft/kosmos-2.5), a multimodal literate model for machine reading of text-intensive images. Kosmos-2.5 excels at two core tasks: generating spatially-aware text blocks (OCR) and producing structured markdown output from images.
...
Returns `fo.Detections` with:
  ...
  * Each detection labeled as âtextâ with actual content in `text_content` attribute
