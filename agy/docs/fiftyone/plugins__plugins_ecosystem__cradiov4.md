---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/cradiov4.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/CRADIOv4)

# NVLabs C-RADIOv4 Models for FiftyOne#

![RADIO Models in FiftyOne](https://raw.githubusercontent.com/harpreetsahota204/CRADIOv4/main/cradio-fiftyone.gif)
...
C-RADIOv4 builds upon AM-RADIO/RADIOv2.5, trained with an updated set of teachers: **SigLIP2** , **DINOv3** , and **SAM3**. This enables strong improvements on key downstream tasks including semantic segmentation, zero-shot classification, and dense perceptionâall at the same computational complexity as previous versions.
...
## Features#
  ...
  * **FiftyOne Integration** : Seamless integration with FiftyOneâs computer vision workflows
...
_Benchmarks: Zero-Shot and kNN accuracy on ImageNet-1K, ADE20k linear probe mIoU. C-RADIOv4 is competitive with DINOv3 on dense tasks at a fraction of the parameters._
...
C-RADIOv4 uses multi-teacher distillation to combine the strengths of three state-of-the-art foundation models:
  ...
  * **SAM3** : Enables replacing SAM3âs vision encoder for segmentation tasks
