---
source_url: https://docs.voxel51.com/model_zoo/models/moonshotai_Kimi_VL_A3B_Thinking_2506.html
---
...
**Details**
  ...
  * Model source: <https://huggingface.co/moonshotai/Kimi-VL-A3B-Thinking-2506>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("moonshotai/Kimi-VL-A3B-Thinking-2506")
    15
