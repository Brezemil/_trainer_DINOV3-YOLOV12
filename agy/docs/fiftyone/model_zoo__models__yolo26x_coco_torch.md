---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26x_coco_torch.html
---

# yolo26x-coco-torch#

Maximum accuracy NMS-free detector.

**Details**

  * Model name: `yolo26x-coco-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("yolo26x-coco-torch")
    13
