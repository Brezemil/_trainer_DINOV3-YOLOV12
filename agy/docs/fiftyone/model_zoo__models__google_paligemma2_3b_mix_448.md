---
source_url: https://docs.voxel51.com/model_zoo/models/google_paligemma2_3b_mix_448.html
---
...
**Details**
  ...
  * Model name: `google/paligemma2-3b-mix-448`

  * Model source: <https://huggingface.co/google/paligemma2-3b-mix-448>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("google/paligemma2-3b-mix-448")
    15
