---
source_url: https://docs.voxel51.com/model_zoo/models/nomic_ai_nomic_embed_multimodal_3b.html
---
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("nomic-ai/nomic-embed-multimodal-3b")
    15
