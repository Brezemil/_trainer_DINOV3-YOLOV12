---
source_url: https://docs.voxel51.com/dataset_zoo/datasets_hf/mind2web_multimodal_test_domain.html
---
...
[![Hugging Face](https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Dataset-yellow)](https://huggingface.co/datasets/Voxel51/mind2web_multimodal_test_domain)

# Dataset Card for âCross-Domainâ Test Split in Multimodal Mind2Web#

**Note** : This dataset is the test split of the Cross-Domain dataset introduced in the paper.

![image/png](https://huggingface.co/datasets/Voxel51/mind2web_multimodal_test_domain/resolve/main/m2w_td.gif)
...
### Direct Use#
  ...
  * Evaluating web agentsâ ability to generalize to entirely new domains
...
The Cross-Domain split was specifically designed to evaluate an agentâs ability to generalize to entirely new domains it hasnât encountered during training, representing the most challenging generalization scenario.
