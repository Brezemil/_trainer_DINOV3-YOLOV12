---
source_url: https://docs.voxel51.com/api/fiftyone.core.map.batcher.id_batch.html
---
...
class fiftyone.core.map.batcher.id_batch.SampleIdBatch(_* sample_ids: [ObjectId](https://pymongo.readthedocs.io/en/stable/api/bson/objectid.html#bson.objectid.ObjectId "\(in PyMongo v4.17.0\)")_)#
...
classmethod split(_sample_collection : [SampleCollection](api__fiftyone.core.map.typing.md#fiftyone.core.map.typing.SampleCollection "fiftyone.core.map.typing.SampleCollection")[T]_, _num_workers : int_, _batch_size : int | None = None_) → List[SampleIdBatch]#
