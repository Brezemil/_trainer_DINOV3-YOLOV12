---
source_url: https://docs.voxel51.com/api/fiftyone.brain.internal.core.mistakenness.html
---
...
`compute_mistakenness`(samples,Â pred_field,Â ...) | See `fiftyone/brain/__init__.py`.  
---|---  
  
**Classes:**

`MistakennessMethodConfig`(pred_field,Â ...) |   
---|---  
`MistakennessMethod`(config) |   
`ClassificationMistakennessConfig`(pred_field,Â ...) |   
`ClassificationMistakenness`(config) |   
`DetectionMistakennessConfig`(pred_field,Â ...) |   
`DetectionMistakenness`(config) |   
  
fiftyone.brain.internal.core.mistakenness.compute_mistakenness(_samples_ , _pred_field_ , _label_field_ , _mistakenness_field_ , _missing_field_ , _spurious_field_ , _use_logits_ , _copy_missing_ , _progress_)#
    

See `fiftyone/brain/__init__.py`.

class fiftyone.brain.internal.core.mistakenness.MistakennessMethodConfig(_pred_field_ , _label_field_ , _mistakenness_field_ , _** kwargs_)#
...
class fiftyone.brain.internal.core.mistakenness.MistakennessMethod(_config_)#
...
class fiftyone.brain.internal.core.mistakenness.ClassificationMistakennessConfig(_pred_field_ , _label_field_ , _mistakenness_field_ , _use_logits_ , _** kwargs_)#
    

Bases: `MistakennessMethodConfig`
...
class fiftyone.brain.internal.core.mistakenness.ClassificationMistakenness(_config_)#
    

Bases: `MistakennessMethod`

**Methods:**

`process_image`(sample_or_frame) |   
---|---  
`get_fields`(samples,Â brain_key) | Gets the fields that were involved in the given run.  
`cleanup`(samples,Â brain_key) | Cleans up the results of the run with the given key from the collection.  
`delete_run`(samples,Â key[,Â cleanup]) | Deletes the results associated with the given run key from the collection.  
`delete_runs`(samples[,Â cleanup]) | Deletes all runs from the collection.  
`ensure_requirements`() | Ensures that any necessary packages to execute this run are installed.  
`ensure_usage_requirements`() | Ensures that any necessary packages to use existing results for this run are installed.  
...
process_image(_sample_or_frame_)#
...
class fiftyone.brain.internal.core.mistakenness.DetectionMistakennessConfig(_pred_field_ , _label_field_ , _mistakenness_field_ , _missing_field_ , _spurious_field_ , _use_logits_ , _copy_missing_ , _eval_key_ , _** kwargs_)#
...
class fiftyone.brain.internal.core.mistakenness.DetectionMistakenness(_config_)#
...
`process_image`(sample_or_frame,Â eval_key) |   
---|---  
`get_fields`(samples,Â brain_key) | Gets the fields that were involved in the given run.  
`cleanup`(samples,Â brain_key) | Cleans up the results of the run with the given key from the collection.  
`delete_run`(samples,Â key[,Â cleanup]) | Deletes the results associated with the given run key from the collection.  
...
process_image(_sample_or_frame_ , _eval_key_)#
