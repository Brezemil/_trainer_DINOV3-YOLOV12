---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26n_seg_coco_torch.html
---

# yolo26n-seg-coco-torch#

Ultra-fast NMS-free instance segmentation.

**Details**

  * Model name: `yolo26n-seg-coco-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("yolo26n-seg-coco-torch")
    13
