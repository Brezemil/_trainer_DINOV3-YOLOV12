---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/colpali_v1_3.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/colpali_v1_3)

# ColPali v1.3 for FiftyOne#

![ColPali Multi-Query Demo](https://raw.githubusercontent.com/harpreetsahota204/colpali_v1_3/main/colpali-mq.gif)
...
[ColPali](https://github.com/illuin-tech/colpali) is a Vision Language Model based on PaliGemma-3B that generates ColBERT-style multi-vector representations for efficient document retrieval. This integration adapts ColPali for use with FiftyOneâs embedding and similarity infrastructure.
...
We use ColPaliâs built-in `HierarchicalTokenPooler` with `pool_factor=3`:

  * Images: `(1031, 128)` â `(~344, 128)`

  * Queries: `(19, 128)` â `(~6, 128)`
...
### Key Implementation Notes#
  ...
  1. **`raw_inputs=True`** : ColPaliProcessor handles all preprocessing, so FiftyOneâs default transforms are disabled
