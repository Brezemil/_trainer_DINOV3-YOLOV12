---
source_url: https://docs.voxel51.com/model_zoo/models/google_gemma_4_E2B_it.html
---
...
**Details**
  ...
  * Model source: <https://huggingface.co/google/gemma-4-E2B-it>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("google/gemma-4-E2B-it")
    15
