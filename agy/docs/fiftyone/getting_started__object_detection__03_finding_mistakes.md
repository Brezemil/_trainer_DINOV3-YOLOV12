---
source_url: https://docs.voxel51.com/getting_started/object_detection/03_finding_mistakes.html
---
...
![mistake-loc](https://cdn.voxel51.com/mistake-loc.webp) In some of these examples, there is not necessarily highly mistaken localization, there are just a bunch of small, relatively overlapping objects. In other examples, such as above, the localization is clearly off. The possible_missing field can also be useful to sort by to find instances of incorrect annotations. Similarly, possible_spurious can be used to find objects that the model detected that may have been missed by annotators.
...
Once again, we can find more of those pesky mistakes! Look at all the missing person annotations here! ![mistake-missing](https://cdn.voxel51.com/mistake-missing.webp) In FiftyOne, we can tag our samples and export them for an annotation job with one of our labeling integrations: [CVAT](https://docs.voxel51.com/integrations/cvat.html), [Label Studio](https://docs.voxel51.com/integrations/labelstudio.html), [V7](https://docs.voxel51.com/integrations/v7.html), or [LabelBox](https://docs.voxel51.com/integrations/labelbox.html)! This can get our dataset back into tip-top shape to train again!
