---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/florence2.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/florence2)

# Florence2 FiftyOne Remote Model Zoo Implementation#

## As of now, Florence2 only works in transformers<4.50.0#

This repository provides a FiftyOne Model Zoo implementation for Florence-2, Microsoftâs powerful multimodal model. The implementation allows seamless integration of Florence-2âs capabilities with FiftyOneâs computer vision tools.
