---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/fast_vlm.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/fast_vlm)

# FastVLM Remote Zoo Models for FiftyOne#

![FastVLM Demo](https://raw.githubusercontent.com/harpreetsahota204/fast_vlm/main/fastvlm-hq.gif)

Appleâs FastVLM vision-language models integrated as FiftyOne remote zoo models, enabling seamless visual question answering in your computer vision workflows.
...
---|---|---|---  
`prompt` | str | âWhat is in this image?â | Question/prompt for all images  
...
`device` | str | auto | Device to use (âcudaâ, âmpsâ, or âcpuâ)  
...
## Performance Tips#
  ...
  3. **Adjust Max Tokens** : Lower `max_new_tokens` for faster inference when detailed responses arenât needed
...
This integration is provided under Apache-2.0 License. The FastVLM model itself is subject to [Appleâs licensing terms](https://github.com/apple/ml-fastvlm/blob/main/LICENSE). âApple Machine Learning Research Model is licensed under the Apple Machine Learning Research Model License Agreement.â
