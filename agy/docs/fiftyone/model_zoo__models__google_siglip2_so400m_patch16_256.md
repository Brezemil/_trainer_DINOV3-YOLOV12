---
source_url: https://docs.voxel51.com/model_zoo/models/google_siglip2_so400m_patch16_256.html
---
...
**Details**
  ...
  * Model name: `google/siglip2-so400m-patch16-256`

  * Model source: <https://huggingface.co/google/siglip2-so400m-patch16-256>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("google/siglip2-so400m-patch16-256")
    15
