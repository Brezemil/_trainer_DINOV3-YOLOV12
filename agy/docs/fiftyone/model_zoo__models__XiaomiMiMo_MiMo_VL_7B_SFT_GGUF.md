---
source_url: https://docs.voxel51.com/model_zoo/models/XiaomiMiMo_MiMo_VL_7B_SFT_GGUF.html
---
...
**Details**
  ...
  * Model source: <https://huggingface.co/XiaomiMiMo/MiMo-VL-7B-SFT-GGUF>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("XiaomiMiMo/MiMo-VL-7B-SFT-GGUF")
    15
