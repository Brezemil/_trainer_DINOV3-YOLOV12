---
source_url: https://docs.voxel51.com/getting_started/annotation/summary.html
---

# Summary: What Youâve Learned#

Youâve completed the Annotation Getting Started Guide. Hereâs what you can now do.
...
FiftyOne integrates with external annotation tools. See [Integrations](https://docs.voxel51.com/integrations/index.html#integrations) for details.
...
## Resources#
  ...
  * [FiftyOne 3D Visualizer](user_guide__app.md#app-3d-visualizer)
  * [FiftyOne Brain - Embeddings](brain.md)
  * [FiftyOne Evaluation API](user_guide__evaluation.md)
  ...
  * [ZCore Repository](https://github.com/voxel51/zcore)
...
Questions or suggestions? Reach us at `support@voxel51.com` or join our [Discord](https://community.voxel51.com). IN THIS ARTICLE 
