---
source_url: https://docs.voxel51.com/model_zoo/models/allenai_MolmoPoint_Img_8B.html
---
...
**Details**
  ...
  * Model name: `allenai/MolmoPoint-Img-8B`

  * Model source: <https://huggingface.co/allenai/MolmoPoint-Img-8B>
  ...
  * Tags: `keypoints, pointing, VLM, zero-shot, image-text-to-text, UI, screenshots`
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("allenai/MolmoPoint-Img-8B")
    15
