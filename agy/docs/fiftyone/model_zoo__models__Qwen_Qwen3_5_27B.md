---
source_url: https://docs.voxel51.com/model_zoo/models/Qwen_Qwen3_5_27B.html
---
...
**Details**
  ...
  * Model source: <https://huggingface.co/Qwen/Qwen3.5-27B>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("Qwen/Qwen3.5-27B")
    15
