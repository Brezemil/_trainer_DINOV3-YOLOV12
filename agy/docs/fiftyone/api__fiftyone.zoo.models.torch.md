---
source_url: https://docs.voxel51.com/api/fiftyone.zoo.models.torch.html
---
...
`TorchvisionImageModelConfig`(d) | Configuration for running a `TorchvisionImageModel`.  
---|---  
`TorchvisionImageModel`(config) | Wrapper for evaluating a `torchvision:torchvision.models` model on images.  
  
class fiftyone.zoo.models.torch.TorchvisionImageModelConfig(_d_)#
...
See [`fiftyone.utils.torch.TorchImageModelConfig`](api__fiftyone.utils.torch.md#fiftyone.utils.torch.TorchImageModelConfig "fiftyone.utils.torch.TorchImageModelConfig") for usage.
...
class fiftyone.zoo.models.torch.TorchvisionImageModel(_config_)#
...
**config** â an `TorchvisionImageModelConfig`
