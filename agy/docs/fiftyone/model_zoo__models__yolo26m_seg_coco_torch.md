---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26m_seg_coco_torch.html
---

# yolo26m-seg-coco-torch#

NMS-free instance segmentation with improved masks.

**Details**

  * Model name: `yolo26m-seg-coco-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("yolo26m-seg-coco-torch")
    13
