---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26s_cls_imagenet_torch.html
---

# yolo26s-cls-imagenet-torch#

Fast image classifier balancing speed and accuracy.

**Details**

  * Model name: `yolo26s-cls-imagenet-torch`
...
**Example usage**
     ...
     9)
    10
    11model = foz.load_zoo_model("yolo26s-cls-imagenet-torch")
    12
