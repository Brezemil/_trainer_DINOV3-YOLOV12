...
![exploring_nyu_depth](https://cdn.voxel51.com/getting_started_depth_estimation/notebook1/exploring_nyu_depth.webp) You may have noticed that each of these datasets are sequences of frames, thus they can be parsed as videos. However, converting frame sequences to MP4 videos is inefficient because:
