---
source_url: https://docs.voxel51.com/model_zoo/models/qwen3_vl_8b_instruct_torch.html
---

# qwen3-vl-8b-instruct-torch#

High-quality vision-language model for object detection via 2D grounding.

**Details**

  * Model name: `qwen3-vl-8b-instruct-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("qwen3-vl-8b-instruct-torch")
    13
