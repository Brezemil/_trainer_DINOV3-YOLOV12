---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26x_pose_coco_torch.html
---

# yolo26x-pose-coco-torch#

Maximum accuracy NMS-free pose estimation.

**Details**

  * Model name: `yolo26x-pose-coco-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("yolo26x-pose-coco-torch")
    13
