---
source_url: https://docs.voxel51.com/api/fiftyone.utils.ultralytics.html
---

# fiftyone.utils.ultralytics#

Utilities for working with [Ultralytics](https://github.com/ultralytics/ultralytics).
...
`convert_ultralytics_model`(model) | Converts the given Ultralytics model into a FiftyOne model.  
---|---  
`to_detections`(results[,Â confidence_thresh,Â ...]) | Converts `ultralytics.YOLO` boxes to FiftyOne format.  
`to_instances`(results[,Â confidence_thresh,Â ...]) | Converts `ultralytics.YOLO` instance segmentations to FiftyOne format.  
`to_classifications`(results[,Â ...]) | Converts `ultralytics.YOLO` classifications to FiftyOne format.  
`obb_to_polylines`(results[,Â ...]) | Converts `ultralytics.YOLO` instance segmentations to FiftyOne format.  
`to_polylines`(results[,Â confidence_thresh,Â ...]) | Converts `ultralytics.YOLO` instance segmentations to FiftyOne format.  
`to_keypoints`(results[,Â confidence_thresh,Â ...]) | Converts `ultralytics.YOLO` keypoints to FiftyOne format.  
  
**Classes:**

`FiftyOneYOLOModelConfig`(d) | Configuration for a `FiftyOneYOLOModel`.  
---|---  
`FiftyOneYOLOModel`(config) | FiftyOne wrapper around an `ultralytics.YOLO` model.  
`FiftyOneRTDETRModelConfig`(d) | Configuration for a `FiftyOneRTDETRModel`.  
`FiftyOneRTDETRModel`(config) | FiftyOne wrapper around an `ultralytics.RTDETR` model.  
`FiftyOneYOLOClassificationModelConfig`(d) | Configuration for a `FiftyOneYOLOClassificationModel`.  
`FiftyOneYOLOClassificationModel`(config) | FiftyOne wrapper around Ultralytics YOLO Classification model.  
`UltralyticsOutputProcessor`([classes]) | Converts Ultralytics PyTorch Hub model outputs to FiftyOne format.  
`UltralyticsPostProcessor`() |   
`UltralyticsClassificationOutputProcessor`([...]) | Converts Ultralytics Classification model outputs to FiftyOne format.  
`UltralyticsDetectionOutputProcessor`([...]) | Converts Ultralytics Detection model outputs to FiftyOne format.  
`UltralyticsSegmentationOutputProcessor`([...]) | Converts Ultralytics Segmentation model outputs to FiftyOne format.  
`UltralyticsPoseOutputProcessor`([classes,Â ...]) | Converts Ultralytics Pose model outputs to FiftyOne format.  
`UltralyticsOBBOutputProcessor`([classes,Â ...]) | Converts Ultralytics Oriented Bounding Box model outputs to FiftyOne format.  
  
fiftyone.utils.ultralytics.convert_ultralytics_model(_model_)#
...
**model** â an `ultralytics.YOLO` model
...
**ValueError** â if the model could not be converted

fiftyone.utils.ultralytics.to_detections(_results_ , _confidence_thresh =None_, _classes =None_)#
...
Parameters:
  ...
  * **results** â a single or list of `ultralytics.engine.results.Results`

  * **confidence_thresh** (_None_) â a confidence threshold to filter boxes

  * **classes** (_None_) â an iterable of classes to filter boxes
...
a single or list of [`fiftyone.core.labels.Detections`](https://docs.voxel51.com/api/fiftyone.core.labels.html#fiftyone.core.labels.Detections "fiftyone.core.labels.Detections")

fiftyone.utils.ultralytics.to_instances(_results_ , _confidence_thresh =None_, _classes =None_)#
...
fiftyone.utils.ultralytics.to_classifications(_results_ , _confidence_thresh =None_, _classes =None_, _store_logits =False_)#
...
Parameters:
  ...
  * **confidence_thresh** (_None_) â a confidence threshold to filter classifications

  * **classes** (_None_) â an iterable of classes to filter classifications

  * **store_logits** (_False_) â whether to store logits on the classifications
...
a single or list of [`fiftyone.core.labels.Classification`](https://docs.voxel51.com/api/fiftyone.core.labels.html#fiftyone.core.labels.Classification "fiftyone.core.labels.Classification")

fiftyone.utils.ultralytics.obb_to_polylines(_results_ , _confidence_thresh =None_, _classes =None_, _filled =False_)#
...
Parameters:
  ...
  * **filled** (_False_) â whether the polyline should be filled
...
fiftyone.utils.ultralytics.to_polylines(_results_ , _confidence_thresh =None_, _classes =None_, _tolerance =2_, _filled =True_)#
...
Parameters:
  ...
  * **tolerance** (_2_) â a tolerance, in pixels, when generating approximate polylines for instance masks. Typical values are 1-3 pixels
...
a single or list of [`fiftyone.core.labels.Polylines`](https://docs.voxel51.com/api/fiftyone.core.labels.html#fiftyone.core.labels.Polylines "fiftyone.core.labels.Polylines")

fiftyone.utils.ultralytics.to_keypoints(_results_ , _confidence_thresh =None_, _classes =None_)#
...
Parameters:
  ...
  * **confidence_thresh** (_None_) â a confidence threshold to filter keypoints

  * **classes** (_None_) â an iterable of classes to filter keypoints
...
a single or list of [`fiftyone.core.labels.Keypoints`](https://docs.voxel51.com/api/fiftyone.core.labels.html#fiftyone.core.labels.Keypoints "fiftyone.core.labels.Keypoints")

class fiftyone.utils.ultralytics.FiftyOneYOLOModelConfig(_d_)#
...
**overrides** (_None_) â a dictionary of overrides for Ultralytics model.
...
class fiftyone.utils.ultralytics.FiftyOneYOLOModel(_config_)#
...
**config** â a FiftyOneYOLOModelConfig
...
class fiftyone.utils.ultralytics.FiftyOneRTDETRModelConfig(_d_)#
    

Bases: `FiftyOneYOLOModelConfig`
...
class fiftyone.utils.ultralytics.FiftyOneRTDETRModel(_config_)#
    

Bases: `FiftyOneYOLOModel`
...
**config** â a `FiftyOneRTDETRModelConfig`
...
class fiftyone.utils.ultralytics.FiftyOneYOLOClassificationModelConfig(_d_)#
    

Bases: `FiftyOneYOLOModelConfig`

Configuration for a `FiftyOneYOLOClassificationModel`.
...
class fiftyone.utils.ultralytics.FiftyOneYOLOClassificationModel(_config_)#
...
**config** â a `FiftyOneYOLOClassificationModelConfig`
...
class fiftyone.utils.ultralytics.UltralyticsOutputProcessor(_classes =None_, _** kwargs_)#
...
class fiftyone.utils.ultralytics.UltralyticsPostProcessor#
...
post_process(_output_)#
    

class fiftyone.utils.ultralytics.UltralyticsClassificationOutputProcessor(_classes =None_, _store_logits =False_, _post_processor =None_)#
    

Bases: [`ClassifierOutputProcessor`](api__fiftyone.utils.torch.md#fiftyone.utils.torch.ClassifierOutputProcessor "fiftyone.utils.torch.ClassifierOutputProcessor"), `UltralyticsPostProcessor`
...
class fiftyone.utils.ultralytics.UltralyticsDetectionOutputProcessor(_classes =None_, _post_processor =None_)#
    

Bases: [`DetectorOutputProcessor`](api__fiftyone.utils.torch.md#fiftyone.utils.torch.DetectorOutputProcessor "fiftyone.utils.torch.DetectorOutputProcessor"), `UltralyticsPostProcessor`
...
class fiftyone.utils.ultralytics.UltralyticsSegmentationOutputProcessor(_classes =None_, _post_processor =None_)#
    

Bases: [`InstanceSegmenterOutputProcessor`](api__fiftyone.utils.torch.md#fiftyone.utils.torch.InstanceSegmenterOutputProcessor "fiftyone.utils.torch.InstanceSegmenterOutputProcessor"), `UltralyticsPostProcessor`
...
class fiftyone.utils.ultralytics.UltralyticsPoseOutputProcessor(_classes =None_, _post_processor =None_)#
    

Bases: [`OutputProcessor`](api__fiftyone.utils.torch.md#fiftyone.utils.torch.OutputProcessor "fiftyone.utils.torch.OutputProcessor"), `UltralyticsPostProcessor`
...
class fiftyone.utils.ultralytics.UltralyticsOBBOutputProcessor(_classes =None_, _post_processor =None_)#
