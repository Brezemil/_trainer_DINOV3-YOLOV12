---
source_url: https://docs.voxel51.com/labs/labs_ecosystem/few_shot_learning.html
---

[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/voxel51/fiftyone-labs/tree/main/plugins/few_shot_learning)
...
Click **Start Session** to initialize. The plugin validates embedding dimensions, creates training label fields (`train_positive`, `train_negative`), and computes embeddings for any samples that donât have them yet.
...
The embedding field name auto-updates when you change the model, but only if you havenât set a custom name. Embeddings are computed automatically for any samples missing them.
