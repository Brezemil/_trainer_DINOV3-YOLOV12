---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26s_pose_coco_torch.html
---

# yolo26s-pose-coco-torch#

Fast NMS-free pose estimation balancing speed and accuracy.

**Details**

  * Model name: `yolo26s-pose-coco-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("yolo26s-pose-coco-torch")
    13
