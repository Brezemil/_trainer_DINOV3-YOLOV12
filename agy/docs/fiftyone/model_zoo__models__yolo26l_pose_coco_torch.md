---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26l_pose_coco_torch.html
---

# yolo26l-pose-coco-torch#

High-accuracy NMS-free pose estimation.

**Details**

  * Model name: `yolo26l-pose-coco-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("yolo26l-pose-coco-torch")
    13
