---
source_url: https://docs.voxel51.com/dataset_zoo/datasets_hf/gui_odyssey_train.html
---
...
[![Hugging Face](https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Dataset-yellow)](https://huggingface.co/datasets/Voxel51/gui-odyssey-train)

# Dataset Card for GUI Odyssey (Train Split)#

![image/png](https://huggingface.co/datasets/Voxel51/gui-odyssey-train/resolve/main/gui_odyssey.gif) Test split shown above, but this also represents the train split.

This is a [FiftyOne](https://github.com/voxel51/fiftyone) dataset with 89365 samples.
...
**Core Fields:**
  ...
  * `device_name`: EmbeddedDocumentField(Classification) - Mobile device type (e.g., âPixel Tabletâ)

  * `step`: IntField - Sequential position within episode (zero-indexed)

  * `category`: EmbeddedDocumentField(Classification) - Task category (e.g., âSocial_Sharingâ)
