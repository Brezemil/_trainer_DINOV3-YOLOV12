---
source_url: https://docs.voxel51.com/model_zoo/models/moonshotai_Kimi_VL_A3B_Thinking.html
---
...
**Details**
  ...
  * Model name: `moonshotai/Kimi-VL-A3B-Thinking`

  * Model source: <https://huggingface.co/moonshotai/Kimi-VL-A3B-Thinking>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("moonshotai/Kimi-VL-A3B-Thinking")
    15
