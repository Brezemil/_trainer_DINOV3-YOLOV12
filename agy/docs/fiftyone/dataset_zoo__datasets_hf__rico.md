---
source_url: https://docs.voxel51.com/dataset_zoo/datasets_hf/rico.html
---
...
[![Hugging Face](https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Dataset-yellow)](https://huggingface.co/datasets/Voxel51/rico)

# Dataset Card for Rico Semantic Dataset#

![image/png](https://huggingface.co/datasets/Voxel51/rico/resolve/main/rico.gif)
...
**Paper:** Liu, T. F., Craft, M., Situ, J., Yumer, E., Mech, R., & Kumar, R. (2018). [Learning Design Semantics for Mobile Apps](https://www.ranjithakumar.net/resources/mobile-semantics.pdf). In The 31st Annual ACM Symposium on User Interface Software and Technology (UIST â18).
...
Each UI element in the hierarchy includes:
  ...
  * Functional classification (e.g., âloginâ for text buttons, âcartâ for icons)
