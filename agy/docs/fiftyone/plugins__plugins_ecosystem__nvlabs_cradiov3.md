---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/nvlabs_cradiov3.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/NVLabs_CRADIOV3)

# NVLabs C-RADIO Models for FiftyOne#

![RADIO Models in FiftyOne](https://raw.githubusercontent.com/harpreetsahota204/NVLabs_CRADIOV3/main/cradio-fiftyone.gif)
...
---|---|---|---|---  
`nv_labs/c-radio_v3-b` | C-RADIOv3-B | ViT-B/16 | 16Ã16 | Fast inference, moderate accuracy  
`nv_labs/c-radio_v3-l` | C-RADIOv3-L | ViT-L/16 | 16Ã16 | Balanced performance  
`nv_labs/c-radio_v3-h` | C-RADIOv3-H | ViT-H/16 | 16Ã16 | High accuracy, recommended  
`nv_labs/c-radio_v3-g` | C-RADIOv3-g | ViT-H/14 | 14Ã14 | Maximum performance  
