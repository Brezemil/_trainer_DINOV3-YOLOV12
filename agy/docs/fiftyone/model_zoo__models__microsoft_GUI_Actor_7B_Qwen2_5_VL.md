---
source_url: https://docs.voxel51.com/model_zoo/models/microsoft_GUI_Actor_7B_Qwen2_5_VL.html
---
...
**Details**
  ...
  * Model name: `microsoft/GUI-Actor-7B-Qwen2.5-VL`

  * Model source: <https://huggingface.co/microsoft/GUI-Actor-7B-Qwen2.5-VL>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("microsoft/GUI-Actor-7B-Qwen2.5-VL")
    15
