---
source_url: https://docs.voxel51.com/api/fiftyone.brain.internal.core.uniqueness.html
---
...
`compute_uniqueness`(samples,Â ...) | See `fiftyone/brain/__init__.py`.  
---|---  
  
**Classes:**

`UniquenessConfig`(uniqueness_field[,Â ...]) |   
---|---  
`Uniqueness`(config) |   
  
fiftyone.brain.internal.core.uniqueness.compute_uniqueness(_samples_ , _uniqueness_field_ , _roi_field_ , _embeddings_ , _similarity_index_ , _model_ , _model_kwargs_ , _force_square_ , _alpha_ , _batch_size_ , _num_workers_ , _skip_failures_ , _progress_)#
    

See `fiftyone/brain/__init__.py`.

class fiftyone.brain.internal.core.uniqueness.UniquenessConfig(_uniqueness_field_ , _roi_field =None_, _embeddings_field =None_, _similarity_index =None_, _model =None_, _model_kwargs =None_, _** kwargs_)#
...
class fiftyone.brain.internal.core.uniqueness.Uniqueness(_config_)#
