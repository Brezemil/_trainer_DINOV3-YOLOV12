---
source_url: https://docs.voxel51.com/plugins/api/plugins.operators.model_evaluation.utils.html
---
...
`CustomCodeViewReason`(value) |   
---|---  
`ShowOptionsMethod`(value) |   
`ScenarioType`(value) |   
  
**Functions:**

`get_scenario_example`([reason,Â type,Â field]) |   
---|---  
  
class plugins.operators.model_evaluation.utils.CustomCodeViewReason(_value_)#
...
class plugins.operators.model_evaluation.utils.ShowOptionsMethod(_value_)#
...
class plugins.operators.model_evaluation.utils.ScenarioType(_value_)#
...
plugins.operators.model_evaluation.utils.get_scenario_example(_reason =ScenarioType.CUSTOM_CODE_, _type =ScenarioType.CUSTOM_CODE_, _field =None_)#
