---
source_url: https://docs.voxel51.com/model_zoo/models/microsoft_Florence_2_large_ft.html
---
...
**Details**
  ...
  * Model name: `microsoft/Florence-2-large-ft`

  * Model source: <https://huggingface.co/microsoft/Florence-2-large-ft>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("microsoft/Florence-2-large-ft")
    15
