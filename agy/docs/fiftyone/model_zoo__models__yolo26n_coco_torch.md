---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26n_coco_torch.html
---

# yolo26n-coco-torch#

Ultra-fast NMS-free detector for edge devices.

**Details**

  * Model name: `yolo26n-coco-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("yolo26n-coco-torch")
    13
