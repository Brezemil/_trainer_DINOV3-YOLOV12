---
source_url: https://docs.voxel51.com/model_zoo/models/google_siglip2_large_patch16_512.html
---
...
**Details**
  ...
  * Model name: `google/siglip2-large-patch16-512`

  * Model source: <https://huggingface.co/google/siglip2-large-patch16-512>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("google/siglip2-large-patch16-512")
    15
