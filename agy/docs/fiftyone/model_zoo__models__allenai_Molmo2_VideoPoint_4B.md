---
source_url: https://docs.voxel51.com/model_zoo/models/allenai_Molmo2_VideoPoint_4B.html
---
...
**Details**
  ...
  * Model name: `allenai/Molmo2-VideoPoint-4B`

  * Model source: <https://huggingface.co/allenai/Molmo2-VideoPoint-4B>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("allenai/Molmo2-VideoPoint-4B")
    15
