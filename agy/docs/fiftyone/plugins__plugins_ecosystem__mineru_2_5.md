---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/mineru_2_5.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/mineru_2_5)

# MinerU 2.5 for FiftyOne#

![image](https://raw.githubusercontent.com/harpreetsahota204/mineru_2_5/main/mineru2_5.gif)
...
The model now supports efficient batching via FiftyOneâs `SupportsGetItem` interface:
...
**Why set batch_size in two places?**
  ...
  * `model.batch_size`: Controls MinerUâs internal inference batching (how many images the VLM processes at once)

  * `apply_model(..., batch_size=...)`: Controls FiftyOneâs DataLoader batching (how many images are loaded in parallel)
