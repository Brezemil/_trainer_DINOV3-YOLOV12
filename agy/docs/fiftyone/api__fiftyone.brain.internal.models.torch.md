---
source_url: https://docs.voxel51.com/api/fiftyone.brain.internal.models.torch.html
---
...
---|---  
`TorchImageModel`(config) | Wrapper for evaluating a Torch model on images whose state dict is stored privately by the Brain.  
  
class fiftyone.brain.internal.models.torch.TorchImageModelConfig(_d_)#
    

Bases: [`TorchImageModelConfig`](api__fiftyone.utils.torch.md#fiftyone.utils.torch.TorchImageModelConfig "fiftyone.utils.torch.TorchImageModelConfig"), [`HasBrainModel`](api__fiftyone.brain.internal.models.md#fiftyone.brain.internal.models.HasBrainModel "fiftyone.brain.internal.models.HasBrainModel")

Configuration for running a `TorchImageModel`.

See [`fiftyone.utils.torch.TorchImageModelConfig`](api__fiftyone.utils.torch.md#fiftyone.utils.torch.TorchImageModelConfig "fiftyone.utils.torch.TorchImageModelConfig") for additional parameters.

Parameters:
    

  * **model_name** (_None_) â the name of the Brain model state dict to load

  * **model_path** (_None_) â the path to a state dict on disk to load
...
class fiftyone.brain.internal.models.torch.TorchImageModel(_config_)#
...
Wrapper for evaluating a Torch model on images whose state dict is stored privately by the Brain.
