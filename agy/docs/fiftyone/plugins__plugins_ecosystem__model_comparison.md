---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/model_comparison.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/allenleetc/model-comparison)

# Model Comparison Plugin#

A [FiftyOne plugin](https://docs.voxel51.com/plugins/index.html) for comparing two object detection models.
...
Tip: in the sample modal, selecting a label and using the âzâ (Crop to content) hotkey will zoom quickly to the relevant ground-truth and prediction labels.

## Implementation#

FiftyOneâs builtin [single-model evaluation](https://docs.voxel51.com/user_guide/evaluation.html#detections) matches ground-truth and predicted detections, storing match status (TP, FN, FP) and associated IOUs on each label.
