---
source_url: https://docs.voxel51.com/api/fiftyone.utils.rerun.html
---

# fiftyone.utils.rerun#

Utilities for working with [Rerun](https://rerun.io/).
...
`RrdFile`(*args,Â **kwargs) | Class for storing a rerun data (rrd) file and its associated metadata.  
---|---  
  
class fiftyone.utils.rerun.RrdFile(_* args_, _** kwargs_)#
...
Parameters:
  ...
  * **filepath** (_None_) â the path to the rrd file

  * **version** (_None_) â the version of the rrd file
