---
source_url: https://docs.voxel51.com/api/fiftyone.core.clips.html
---
...
`ClipView`(doc,Â view[,Â selected_fields,Â ...]) | A clip in a `ClipsView`.  
---|---  
`ClipsView`(source_collection,Â clips_stage,Â ...) | A [`fiftyone.core.view.DatasetView`](api__fiftyone.core.view.md#fiftyone.core.view.DatasetView "fiftyone.core.view.DatasetView") of clips from a video [`fiftyone.core.dataset.Dataset`](https://docs.voxel51.com/api/fiftyone.core.dataset.html#fiftyone.core.dataset.Dataset "fiftyone.core.dataset.Dataset").  
`TrajectoriesView`(source_collection,Â ...[,Â ...]) | A `ClipsView` of object trajectories from a video [`fiftyone.core.dataset.Dataset`](https://docs.voxel51.com/api/fiftyone.core.dataset.html#fiftyone.core.dataset.Dataset "fiftyone.core.dataset.Dataset").  
  
**Functions:**

`make_clips_dataset`(sample_collection,Â ...[,Â ...]) | Creates a dataset that contains one sample per clip defined by the given field or expression in the collection.  
---|---  
  
class fiftyone.core.clips.ClipView(_doc_ , _view_ , _selected_fields =None_, _excluded_fields =None_, _filtered_fields =None_)#
...
`ClipView` instances should not be created manually; they are generated by iterating over `ClipsView` instances.
...
Parameters:
  ...
  * **view** â the `ClipsView` that the frame belongs to
...
class fiftyone.core.clips.ClipsView(_source_collection_ , _clips_stage_ , _clips_dataset_ , __stages =None_, __media_type =None_, __name =None_)#
    

Bases: [`DatasetView`](api__fiftyone.core.view.md#fiftyone.core.view.DatasetView "fiftyone.core.view.DatasetView")

A [`fiftyone.core.view.DatasetView`](api__fiftyone.core.view.md#fiftyone.core.view.DatasetView "fiftyone.core.view.DatasetView") of clips from a video [`fiftyone.core.dataset.Dataset`](https://docs.voxel51.com/api/fiftyone.core.dataset.html#fiftyone.core.dataset.Dataset "fiftyone.core.dataset.Dataset").

Clips views contain an ordered collection of clips, each of which corresponds to a range of frame numbers from the source collection.

Clips retrieved from clips views are returned as `ClipView` objects.
...
Parameters:
  ...
  * **clips_stage** â the [`fiftyone.core.stages.ToClips`](api__fiftyone.core.stages.md#fiftyone.core.stages.ToClips "fiftyone.core.stages.ToClips") stage that defines how the clips were created

  * **clips_dataset** â the [`fiftyone.core.dataset.Dataset`](https://docs.voxel51.com/api/fiftyone.core.dataset.html#fiftyone.core.dataset.Dataset "fiftyone.core.dataset.Dataset") that serves the clips in this view
...
`save`([fields]) | Saves the clips in this view to the underlying dataset.  
`keep`() | Deletes all clips that are **not** in this view from the underlying dataset.  
`keep_fields`() | Deletes any frame fields that have been excluded in this view from the frames of the underlying dataset.  
...
This will permanently delete any omitted or filtered contents from the frames of the underlying dataset.
...
Note that `ClipView` instances are not singletons, so any in-memory clips extracted from this view will not be updated by calling this method.
...
class fiftyone.core.clips.TrajectoriesView(_source_collection_ , _clips_stage_ , _clips_dataset_ , __stages =None_, __media_type =None_, __name =None_)#
    

Bases: `ClipsView`

A `ClipsView` of object trajectories from a video [`fiftyone.core.dataset.Dataset`](https://docs.voxel51.com/api/fiftyone.core.dataset.html#fiftyone.core.dataset.Dataset "fiftyone.core.dataset.Dataset").
...
Clips retrieved from trajectories views are returned as `ClipView` objects.
...
Parameters:
  ...
  * **clips_stage** â the [`fiftyone.core.stages.ToTrajectories`](api__fiftyone.core.stages.md#fiftyone.core.stages.ToTrajectories "fiftyone.core.stages.ToTrajectories") stage that defines how the clips were created
...
fiftyone.core.clips.make_clips_dataset(_sample_collection_ , _field_or_expr_ , _other_fields =None_, _include_indexes =False_, _tol =0_, _min_len =0_, _trajectories =False_, _name =None_, _persistent =False_, __generated =False_)#
...
In addition, sample-level fields will be added for certain clipping strategies:
  ...
  * When `field_or_expr` is a temporal detection(s) field, the field will be converted to a [`fiftyone.core.labels.Classification`](https://docs.voxel51.com/api/fiftyone.core.labels.html#fiftyone.core.labels.Classification "fiftyone.core.labels.Classification") field
...
controls whether sample fields other than the default sample fields are included. Can be any of the following:
  ...
  * **include_indexes** (_False_) â whether to recreate any custom indexes on `field_or_expr` and `other_fields` on the new dataset (True) or a list of specific indexes or index prefixes to recreate. By default, no custom indexes are recreated
