---
source_url: https://docs.voxel51.com/model_zoo/models/apple_FastVLM_0_5B.html
---
...
**Details**
  ...
  * Model name: `apple/FastVLM-0.5B`

  * Model source: <https://huggingface.co/apple/FastVLM-0.5B>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("apple/FastVLM-0.5B")
    15
