---
source_url: https://docs.voxel51.com/dataset_zoo/datasets_hf/screenspot_v2.html
---
...
[![Hugging Face](https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Dataset-yellow)](https://huggingface.co/datasets/Voxel51/ScreenSpot-v2)

# Dataset Card for ScreenSpot-V2#

![image/png](https://huggingface.co/datasets/Voxel51/ScreenSpot-v2/resolve/main/screenspot_v2.gif)
...
**Core Fields:**
  ...
  * `data_source`: EmbeddedDocumentField(Classification) - Operating system (e.g., âmacosâ)

  * `action_detection`: EmbeddedDocumentField(Detection) - Target interaction element:

    * `label`: Element type (e.g., âtextâ, âiconâ)
