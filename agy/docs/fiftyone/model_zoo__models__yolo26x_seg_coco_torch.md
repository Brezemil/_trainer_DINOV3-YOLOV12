---
source_url: https://docs.voxel51.com/model_zoo/models/yolo26x_seg_coco_torch.html
---

# yolo26x-seg-coco-torch#

Maximum accuracy NMS-free instance segmentation.

**Details**

  * Model name: `yolo26x-seg-coco-torch`
...
**Example usage**
    ...
    10)
    11
    12model = foz.load_zoo_model("yolo26x-seg-coco-torch")
    13
