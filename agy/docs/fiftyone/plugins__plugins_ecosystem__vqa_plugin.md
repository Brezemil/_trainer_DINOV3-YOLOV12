---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/vqa_plugin.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/jacobmarks/vqa-plugin)
...
## Updates#
  ...
  * **2024-05-03** : [@harpreetsahota204](https://github.com/harpreetsahota204) added support for Idefics-8b model from [Replicate](https://replicate.com/).

  * **2023-10-24** : Added support for Llava-13b and Fuyu-8b models from [Replicate](https://replicate.com/).
