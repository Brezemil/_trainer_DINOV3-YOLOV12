---
source_url: https://docs.voxel51.com/model_zoo/models/XiaomiMiMo_MiMo_VL_7B_SFT.html
---
...
**Details**
  ...
  * Model name: `XiaomiMiMo/MiMo-VL-7B-SFT`

  * Model source: <https://huggingface.co/XiaomiMiMo/MiMo-VL-7B-SFT>
...
**Example usage**
    ...
    12)
    13
    14model = foz.load_zoo_model("XiaomiMiMo/MiMo-VL-7B-SFT")
    15
