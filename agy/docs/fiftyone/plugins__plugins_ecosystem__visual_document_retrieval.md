---
source_url: https://docs.voxel51.com/plugins/plugins_ecosystem/visual_document_retrieval.html
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-black?logo=github)](https://github.com/harpreetsahota204/visual_document_retrieval)
...
## Features#
  ...
  * **Seamless FiftyOne Integration** : Works with FiftyOneâs Brain tools for dataset exploration
...
## Limitations#
  ...
  * While it can process natural photos, itâs specialized for text-containing images
...
This implementation is provided under the terms of the [base modelâs license (LlamaIndex/VDR-2B-V1), which is Apache 2.0](https://choosealicense.com/licenses/apache-2.0/).
