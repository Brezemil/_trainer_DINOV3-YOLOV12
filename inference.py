...
Examples:
    ...
    parser.add_argument("--weights", "-w", type=str, required=True, help="Path to trained model weights (.pt file)")
    ...
    parser.add_argument(
        "--output", "-o", type=str, default=None, help="Output directory for results (default: runs/detect/predict)"
    )
    ...
    parser.add_argument(
        "--device", type=str, default="", help="Device to run on (cpu, cuda, mps, etc.) (default: auto-detect)"
    )
